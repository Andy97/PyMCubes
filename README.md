...
## ** This is a modified version of original mcubes, a new method *marching_cubes_partial* is added. In this version, we ignores the grids with corner function value |f| > 10000.(which speedup the computation) **
